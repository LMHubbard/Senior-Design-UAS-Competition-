...
pitch_pid = PID(2.5, 2.5, 0.085, setpoint=0, output_limits=(output_min, output_max))
# initialize the pid loop for the gimbal roll axis
roll_pid = PID(2.5, 2.5, 0.085, setpoint=0, output_limits=(output_min, output_max))
...
def final_targeting_stage(marker_ids, marker_centers, all_distances):
    ...
    if marker_to_engage != -1 and all(
        ...
        roll = roll + roll_output
        pitch = pitch - pitch_output
