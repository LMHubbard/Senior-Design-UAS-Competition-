...
search_speed = 2.25 # m/s speed to search for marker in waypoint stage
align_speed = 0.75 # m/s speed to align vehicle to marker
ALTITUDE = 2.5  # Altitude to take off to (meters)
...
xy_error_threshold_stage1 = 0.625  # the threshold under which to begin dropping altitude while aligning
        ...
        if not queue.empty():
            ...
            if run_initial_search is True:
                ...
                if has_path_been_generated is False:
                    ...
                    print(heading_deg)
                    condition_yaw(vehicle, heading_deg, relative=False) # set the yaw angle
